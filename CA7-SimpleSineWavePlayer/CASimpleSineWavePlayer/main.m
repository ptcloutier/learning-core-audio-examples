//
//  main.m
//  CASimpleSineWavePlayer
//
//  Created by Perrin Cloutier on 4/20/18.
...
void CreateAndConnectOutputUnit (MySineWavePlayer *player) {
    // Generates a description that matches the output
    // device (speakers)
...
int main(int argc, const char *argv[]) {
    ...
    sleep(5);
    // cleanup
    CheckError(AudioOutputUnitStop(player.outputUnit),
               "Error stopping AudioOutputUnit");
